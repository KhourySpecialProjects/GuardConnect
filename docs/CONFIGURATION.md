...
|--------|----------|---------|----------|
| Database password | Auto-generated by RDS | Server | ✅ Auto (no downtime) |
| Redis AUTH | Auto-generated by Terraform | Server | Manual |
| VAPID keys (public, private, contact) | **Manual** (you create) | Server + Web | Manual |

### Database Password Auto-Rotation

The database password supports automatic rotation without downtime. The application:
- Polls AWS Secrets Manager every 5 minutes
- Detects credential changes automatically
- Reconnects with new credentials gracefully
- Maintains zero downtime during rotation

**See [DATABASE-SECRET-ROTATION.md](./DATABASE-SECRET-ROTATION.md) for complete details.**
