          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                ...
                variant="outline"
                size="icon"
                className="rounded-full border border-primary/50 bg-card text-primary shadow-sm transition hover:bg-primary/10"
              ...
              {creationActions.map((action) => (
                <DropdownMenuItem key={action.label} asChild>
                  <Link
                    ...
                    className="flex items-center gap-2 rounded-xl px-3 py-2 text-sm font-medium text-secondary focus:bg-primary/10 data-[highlighted]:bg-primary/10"
                  >
